...
export default function DetailComponent({showDetail}) {
    return(
        <>
        <Container className={`detail ${showDetail && "active"}`} >
            ...
            <Col md={12} lg={4}>
              ...
              >
                <img
                  ...
                  src="//product.hstatic.net/200000690725/product/7_4d50f92cb2ff4039b3f7cfbc1f0509f6_master.png"
                  alt="product1"
                />
              </div>
                ...
                <ul className="list-unstyled row row-cols-6 g-1">
                  <li className="col">
                    <img
                      ...
                      src="//product.hstatic.net/200000690725/product/7_4d50f92cb2ff4039b3f7cfbc1f0509f6_compact.png"
                      alt=""
                    />
                  </li>
                  <li className="col">
            ...
            <Col md={12} lg={8}  className="border-start">
              <div style={{ width: "70%" }} className="mt-2">
                <div>
                  <h1>Áo Polo trơn basic đen thêu logo ngực ESTP038 - Đen</h1>
                </div>
                <div>
                  <span className="pe-2 border-end"> Mã sản phẩm : </span>
                  <span className="px-2 border-end">
                    {" "}
                    Tình trạng :<b className="fw-bold">Còn hàng</b>
                  </span>
                  <span className="ps-2">
