  ...
  const thumbnails = [
   ...
   useEffect(
    ...
    return(
        ...
        onClick={()=>{d(closeDetail({showDetail:false , productId:null}))}}
      ></div>
                        ...
                        <div style={{ width: "100%" }} className="mt-2">
                          <div className="position-relative pt-4">
                            <h4 className="fw-bold">{productItem.name}</h4>
                               ...
                               <IoCloseOutline className="position-absolute  top-0 end-0 fs-4  " onClick={()=>{d(closeDetail({showDetail:false , productId:null}))}}/>
                          </div>
